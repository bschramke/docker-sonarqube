...
run:
	docker run -d --name $(subst /,-,$(NAME)) -p 9000:9000 -p 9092:9092 $(NAME):$(VERSION)
...
version:
	docker run -it --rm $(NAME):$(VERSION) sh -c " cat /etc/os-release" | tee COMPONENTS
	dos2unix COMPONENTS
